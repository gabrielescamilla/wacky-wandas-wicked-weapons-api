...
if Weapon.count == 0 then
  ...
  Weapon.create category: "Exotic", subcategory: "Light Melee Weapons", name: "Rope Gauntlet", cost: 20, damage: "1d3", range: nil, weight: 2, tag:"gauntlet.jpg"
  ...
  Weapon.create category: "Exotic", subcategory: "Two-Handed Melee Weapons", name: "Seven-branched Sword", cost: 5000, damage: "1d8", range: nil, weight: 7
  Weapon.create category: "Exotic", subcategory: "Two-Handed Melee Weapons", name: "Two-Bladed Sword", cost: 10000, damage: "1d6", range: nil, weight: 10
